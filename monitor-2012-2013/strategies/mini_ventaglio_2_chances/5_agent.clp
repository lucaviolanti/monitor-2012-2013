...
(deftemplate kagent_cell 
	...
	(slot visited (default 0))		;//~ indica quante volte ci sono effettivamente passato sopra
...
(defrule perc-agent-north
 ...
 =>
	...
	(modify ?f4 (percepted ?p4))(modify ?f5 (percepted ?p5))(modify ?f6 (percepted ?p6))
...
(defrule decrease-utility-visited-1st-time
	(declare (salience 155))
	(local_perc (p 8) (r ?r) (c ?c))
	?ka <- (kagent_cell (pos-r ?r) (pos-c ?c) (visited 1) (utility 120|100|20))
 =>
	(modify ?ka (utility 15))
)

(defrule decrease-utility-visited-2nd-time
	(declare (salience 155))
	(local_perc (p 8) (r ?r) (c ?c))
	?ka <- (kagent_cell (pos-r ?r) (pos-c ?c) (visited 2) (utility 15))
 =>
