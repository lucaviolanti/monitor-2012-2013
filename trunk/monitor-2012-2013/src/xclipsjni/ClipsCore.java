...
/**Questa classe implemente il cuore di connessione con l'ambiente clips, estende e migliora i metodi già offerti dalle librerie
...
public class ClipsCore {
	...
	public ClipsCore() {
            ...
            clips.load("6_checker.clp");
            clips.load("7_planner.clp");
	...
	/**Metodo da usare con cautela, serve per un comando su un modulo in clips. La sintassi dev'essere quella di clips,
	 * non verranno eseguiti controlli sulla stringa passata, quindi fare attenzione.
	 * 
	...
	/**Resetta l'Environment Clips: cancella tutti i facts presenti nella WM e asserisce tutti i facts
	 * dichiarati negli initial
	 *
	 */
	public void reset() {
		clips.reset();
	 ...
	 * Prestare attenzione alla precisione nei campi inseriti, che devono corrispondere ai campi del file Clips.
	 *
	 * @param module il modulo in cui sono visibili i facts
	 * @param template il "tipo" di fatto non ordinato a cui si e' interessati
	 * @param conditions le condizioni di ricerca dei facts, inserire TRUE se si vogliono tutti i facts di un certo tipo
	 * @param slots gli slot dei facts che si vuole vengano restituiti
	 * @return una tabella di stringhe in cui ad ogni riga corrisponde un fatto che soddisfa l'interrogazione, e ad ogni colonna uno slot di quel fatto, secondo l'ordine in cui sono dichiarati nel campo slots. null se non c'e' nessun fatto che soddisfa l'interrogazione
	...
	/**Equivalente alla funzione di Clips find-fact(vedere manuale per maggiori informazioni e sintassi delle conditions).
	 * Restituisce il primo fatto non ordinato corrispondente ad una certa interrogazione.
	 * Prestare attenzione alla precisione nei campi inseriti, che devono corrispondere ai campi del file Clips.
	 *
	 * @param module il modulo in cui e' visibile il fatto
	 * @param template il "tipo" di fatto non ordinato a cui si e' interessati
	 * @param conditions le condizioni di ricerca del fatto, inserire TRUE se non ci sono condizioni
	 * @param slots gli slot del fatto che si vuole vengano restituiti
	 * @return un array di stringhe in cui ad ogni colonna corrisponde uno slot di quel fatto, secondo l'ordine in cui sono dichiarati nel campo slots. null se non c'e' nessun fatto che corrisponde all'interrogazione
	 * @throws ClipsException
	 */
	 ...
	 * Restituisce il primo fatto ordinato corrispondente ad una certa interrogazione.
	 * Prestare attenzione alla precisione nei campi inseriti, che devono corrispondere ai campi del file Clips.
	 *
	 * @param module il modulo in cui e' visibile il fatto
	 * @param template il symbol con cui inizia il fatto ordinato a cui si e' interessati
	 ...
	 * Restituisce la lista delle funzioni attualmente attivabili, in ordine di priorita' di attivazione.
	 *
	 ...
	 * @param rule la regola da inserire. Attenzione a scriverla bene in linguaggio clips, perchè non sarà controllata.
