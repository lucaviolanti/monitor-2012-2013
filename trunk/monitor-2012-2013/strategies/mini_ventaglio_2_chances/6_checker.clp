...
(defrule check-forward
	...
	(local_perc (p 2) (r ?r2) (c ?c2))
	(local_perc (p 4) (r ?r4) (c ?c4))
	(local_perc (p 6) (r ?r6) (c ?c6))
	(not (kagent_cell (pos-r ?r2) (pos-c ?c2) (type hill|border)))
	(kagent_cell (pos-r ?r4) (pos-c ?c4) (utility ?u4))
	(kagent_cell (pos-r ?r6) (pos-c ?c6) (utility ?u6))
	(kagent_cell (pos-r ?r2) (pos-c ?c2) (utility ?u2))
	(test (and (>= ?u2 ?u6) (>= ?u2 ?u4) (> ?u2 10)))
 ...
 =>	
	(retract ?fc)
	(assert
		(future_cell (pos-r ?r2) (pos-c ?c2) (direction ?dir))
...
(defrule check-right-north
	...
	(local_perc (p 4) (r ?r4) (c ?c4))
	(local_perc (p 6) (r ?r6) (c ?c6))
	(not (kagent_cell (pos-r ?r6) (pos-c ?c6) (type hill|border)))	
	(kagent_cell (pos-r ?r2) (pos-c ?c2) (utility ?u2))
	(kagent_cell (pos-r ?r4) (pos-c ?c4) (utility ?u4))
	(kagent_cell (pos-r ?r6) (pos-c ?c6) (utility ?u6))
	(test (and (>= ?u6 ?u2) (>= ?u6 ?u4) (> ?u6 10)))
	?fc <- (future_cell (pos-r ?) (pos-c ?) (direction ?))
	(not (next_action (action ?) (safety safe)))
...
=>	
	(retract ?fc)
	(assert
		(future_cell (pos-r ?r6) (pos-c ?c6) (direction east))
...
(defrule check-right-south
 ...
 =>	
	(retract ?fc)
	(assert
		(future_cell (pos-r ?r6) (pos-c ?c6) (direction west))
		(next_action (action go-right))
	)
	(focus PLANNER)
)
...
(defrule check-right-east
 ...
 =>	
	(retract ?fc)
	(assert
		(future_cell (pos-r ?r6) (pos-c ?c6) (direction south))
		(next_action (action go-right))
	)
	(focus PLANNER)
)
...
(defrule check-right-west
 ...
 =>	
	(retract ?fc)
	(assert
		(future_cell (pos-r ?r6) (pos-c ?c6) (direction north))
		(next_action (action go-right))
	)
	(focus PLANNER)
)
...
(defrule check-left-north
	...
	(local_perc (p 4) (r ?r4) (c ?c4))
	(local_perc (p 6) (r ?r6) (c ?c6))
	(not (kagent_cell (pos-r ?r4) (pos-c ?c4) (type hill|border)))	
	(kagent_cell (pos-r ?r2) (pos-c ?c2) (utility ?u2))
	(kagent_cell (pos-r ?r6) (pos-c ?c6) (utility ?u6))
	(kagent_cell (pos-r ?r4) (pos-c ?c4) (utility ?u4))	
	(test (and (>= ?u4 ?u2) (>= ?u4 ?u6) (> ?u4 10)))
	?fc <- (future_cell (pos-r ?) (pos-c ?) (direction ?))
	(not (next_action (action ?) (safety safe)))
 ...
 =>	
	(retract ?fc)
	(assert
		(future_cell (pos-r ?r4) (pos-c ?c4) (direction west))
...
(defrule check-left-south
 ...
 =>	
	(retract ?fc)
	(assert
		(future_cell (pos-r ?r4) (pos-c ?c4) (direction east))
		(next_action (action go-left))
	)
	(focus PLANNER)
)
...
(defrule check-left-east
 ...
 =>	
	(retract ?fc)
	(assert
		(future_cell (pos-r ?r4) (pos-c ?c4) (direction north))
		(next_action (action go-left))
	)
	(focus PLANNER)
)
...
(defrule check-left-west
 ...
 =>	
	(retract ?fc)
	(assert
		(future_cell (pos-r ?r4) (pos-c ?c4) (direction south))
		(next_action (action go-left))
	)
	(focus PLANNER)
)
